...
driver.get('https://www.redbus.in/search?fromCityName=Hosur,%20Bangalore&fromCityId=66226&srcCountry=IND&toCityName=Chennai&toCityId=123&destCountry=IND&onward=3-Oct-2024&opId=0&busType=Any')
...
s=pd.DataFrame(data)
s.to_sql("redbus12",engine,if_exists='replace',index=False)
