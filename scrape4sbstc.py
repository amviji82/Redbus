...
driver.get('https://www.redbus.in/bus-tickets/durgapur-to-kolkata?fromCityId=69802&toCityId=74820&fromCityName=Durgapur%20(West%20Bengal)&toCityName=Kolkata&busType=Any&srcCountry=IND&destCountry=IND&onward=28-Sep-2024')
time.sleep(3)
...
s=pd.DataFrame(data)
s.to_sql("redbus4",engine,if_exists='replace',index=False)
