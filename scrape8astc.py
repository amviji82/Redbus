...
driver.get('https://www.redbus.in/bus-tickets/tezpur-to-guwahati?fromCityId=90883&toCityId=74701&fromCityName=Tezpur&toCityName=Guwahati&busType=Any&srcCountry=IND&destCountry=IND&onward=28-Sep-2024')
time.sleep(3)
...
s=pd.DataFrame(data)
s.to_sql("redbus8",engine,if_exists='replace',index=False)
