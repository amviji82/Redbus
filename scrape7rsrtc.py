...
driver.get('https://www.redbus.in/bus-tickets/udaipur-to-jodhpur?fromCityId=470&toCityId=1169&fromCityName=Udaipur&toCityName=Jodhpur&busType=Any&onward=28-Sep-2024')
time.sleep(3)
...
s=pd.DataFrame(data)
s.to_sql("redbus7",engine,if_exists='replace',index=False)
