...
driver.get('https://www.redbus.in/bus-tickets/gopalganj-to-delhi?fromCityId=81384&toCityId=733&fromCityName=Gopalganj%20(Bihar)&toCityName=Delhi&busType=Any&srcCountry=IND&destCountry=IND&onward=28-Sep-2024')
time.sleep(3)
...
s=pd.DataFrame(data)
s.to_sql("redbus10",engine,if_exists='replace',index=False)
