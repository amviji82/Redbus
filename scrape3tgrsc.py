...
driver.get('https://www.redbus.in/bus-tickets/hyderabad-to-vijayawada?fromCityId=124&toCityId=134&fromCityName=Hyderabad&toCityName=Vijayawada&busType=Any&onward=26-Sep-2024')
time.sleep(3)
...
s=pd.DataFrame(data)
s.to_sql("redbus3",engine,if_exists='replace',index=False)
