...
driver.get('https://www.redbus.in/bus-tickets/delhi-to-shimla?fromCityId=733&toCityId=1285&fromCityName=Delhi&toCityName=Shimla&busType=Any&srcCountry=IND&destCountry=IND&onward=28-Sep-2024')
time.sleep(3)
...
s=pd.DataFrame(data)
s.to_sql("redbus5",engine,if_exists='replace',index=False)
