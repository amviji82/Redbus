...
driver.get('https://www.redbus.in/bus-tickets/pune-to-goa?fromCityId=130&toCityId=210&fromCityName=Pune&toCityName=Goa&busType=Any&srcCountry=IND&destCountry=IND&onward=28-Sep-2024')
time.sleep(3)
...
s=pd.DataFrame(data)
s.to_sql("redbus6",engine,if_exists='replace',index=False)
